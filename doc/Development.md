# Development and Testing Dashboard <br/> Dashboards Microservice Client SDK for Node.js
...
```bash
git clone git@github.com:pip-services-content/pip-clients-dashboards-node.git
```
